...
[![iOS Deployment Target](https://img.shields.io/badge/iOS-15.0%2B-blue.svg)](https://cocoapods.org/pods/DeviceImpressSwift)
...
├── Device/
│   ├── DeviceService.swift    # 设备基础信息
│   └── PhoneService.swift     # 设备型号识别
├── Storage/
│   └── StorageService.swift   # 内存和磁盘存储
├── Time/
│   └── TimeService.swift      # 系统时间相关
├── Network/
